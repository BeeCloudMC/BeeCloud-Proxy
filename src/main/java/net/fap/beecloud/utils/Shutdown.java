...
import net.fap.beecloud.network.mcpe.protocol.ProxyEventPacket;
	...
	public static void shutdownTask() {
		Runtime.getRuntime().addShutdownHook(new Thread() {
			...
			public void run() {
				...
				ProxyEventPacket packet = new ProxyEventPacket();
				packet.setEvent(ProxyEventPacket.EVENT_SHUTDOWN);
